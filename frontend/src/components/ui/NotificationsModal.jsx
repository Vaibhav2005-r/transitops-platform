          ...
          <div className="p-4 border-b border-slate-200/50 flex justify-between items-center bg-white/50 sticky top-0">
            <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
              ...
              {notifications.length > 0 && (
                <span className="bg-rose-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm">{notifications.length} New</span>
              )}
            </h2>
          ...
          <div className="overflow-y-auto p-2 min-h-[200px]">
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-slate-400 py-12">
                <MdNotificationsOff className="text-5xl mb-3 text-slate-300" />
